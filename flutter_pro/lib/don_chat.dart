...
class OrgChatScreen1 extends StatefulWidget {
  static const String routeName = '/OrgChatScreen';

  @override
  State<OrgChatScreen1> createState() => _OrgChatScreenState1();
}

class _OrgChatScreenState1 extends State<OrgChatScreen1> {
  ...
  Future<void> loadMessages() async {
    try {
      ...
      String categoryUrl = ip + "/api/view_donor_chat_list";
  ...
  Future<void> sendMessage(String message) async {
    try {
      ...
      String ip = pref.getString("url") ?? "";
      String sendMessageUrl = ip + "/api/chat_donor_with_admin";
